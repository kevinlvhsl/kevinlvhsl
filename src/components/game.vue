...
.game-box
    ul.puzzle-wrap
      li(:class="{'puzzle': true, 'puzzle-empty': !puzzle}", v-for='puzzle in puzzles', v-text='puzzle', @click='moveFn($index)')
    button.btn.btn-warning.btn-block.btn-reset(@click='render') 重置游戏
